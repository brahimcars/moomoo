...
function clearObject() {
	document.getElementById("body").value = 22;
	document.getElementById("shape").value = "circle";
	document.getElementById("color").value = "#bf8f54";
	barrels = [];
}
...
function graxClick() {
    if (newGraphx === true) {
        newGraphx = false;
        document.getElementById("graphicButton").innerHTML = "Night";
    } else if (newGraphx === false) {
        newGraphx = true;
        document.getElementById("graphicButton").innerHTML = "Day";
    }
}
